                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            {item.stats && (
                             ...
                             {item.link && (
                                <a href={item.link} target="_blank" rel="noopener noreferrer" className="absolute bottom-8 right-8 opacity-0 group-hover:opacity-100 transition-opacity duration-300">

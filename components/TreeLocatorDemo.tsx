  ...
  <div className={`absolute inset-0 flex items-center justify-center z-20 text-center max-w-lg mx-auto px-6 pointer-events-none transition-transform duration-1000 ${shiftedUp ? '-translate-y-[30vh]' : ''}`}>
    <div key={animKey} className="animate-fadeIn">
      ...
      <a
        ...
        className={`pointer-events-auto inline-flex items-center gap-2 mt-6 px-4 py-2 bg-[#24292e] text-white text-sm font-medium rounded-md hover:bg-[#2f363d] transition-all duration-500 border border-[#444c56] ${showGithub ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
      >
